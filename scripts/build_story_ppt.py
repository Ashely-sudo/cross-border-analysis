...
bullets(s, [
    ('我上一份工作在 U.S. Solid 做亚马逊运营。它做自有品牌出海，卖阀门/管件、实验室仪器、封口机这类偏专业的产品，在售 SKU 超过 1000 个。', 0, False),
    ...
    ('让我一直没想通的是：单个 SKU 怎么算都能盈利，公司整体却一年比一年不赚钱。', 0, False),
    ('我怀疑问题出在两处：平台拿走的佣金、仓储和广告费用，或是我们这种把 SKU 铺得很开的打法本身有问题。', 0, False),
    ('这些靠经验判断不了，我决定用数据验证：不用现成数据集，用上市公司财报和海关官方数据，从行业层面重新看一遍。', 0, False),

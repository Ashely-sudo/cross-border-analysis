...
rows2 = [
    ...
    ("猜测：", "① 行业层面：增速换挡、竞争者涌入，流量与广告成本整体抬升；② 模式层面：精品/铺货/长尾的费用结构差异大，销售费用率可能吃掉毛利；③ 市场与渠道：过度押注单一平台或市场，议价与毛利受限；④ 资金层面：备货与回款占用现金，账面盈利未必变成真金白银"),
    ("验证：", "以 5 家上市公司为样本，用公开财报和海关数据，从行业、公司、现金流三个层面验证：哪些因素真正解释了“单品盈利却没带来整体增长”。"),
]

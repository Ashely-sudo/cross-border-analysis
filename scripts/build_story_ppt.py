...
bullets(s, [
    ('上一份工作在 U.S. Solid 做亚马逊运营——自有品牌出海，卖阀门/管件、实验室仪器、封口机这类偏专业的设备，店铺里 1000+ SKU。', 0, False),
    ('打法是把一个品类做全：同一种阀，两通、三通，1/2"~2"，不锈钢、黄铜、PVC 都上。买家多是工程师、实验室或做自动化改造的人，很懂行，照着型号买。', 0, False),
    ('我除了日常运营，还兼新品选品：定价前先算单件 ROI，再决定广告和备货怎么排。', 0, False),
    ('但越算越困惑：单看每个 SKU 的 ROI 都过得去，公司整体却一年比一年不赚钱。', 0, True),
    ('钱到底被谁赚走了？是平台佣金、仓储费、广告费，还是我们这种把 SKU 铺得很开的打法本身有问题？', 0, True),
    ('想不通就自己查：不套现成数据集，用上市公司财报 + 海关官方数据，从行业层面验证一遍。', 0, False),
...
r4.text = "我的经历：U.S. Solid 1000+ SKU 按规格矩阵做全 —— 第三种路径“目录式长尾品牌”。"

...
rows2 = [
    ...
    ("问题：", "大部分 SKU 单独核算均为盈利，但公司在亚马逊平台的整体表现不佳。为什么“单品盈利”没有带来“整体赚钱”？"),
    ...
    ("验证：", "以 5 家上市公司为样本，用公开财报和海关数据，从行业、公司、现金流三个层面验证：哪些因素真正解释了“单品盈利却没带来整体赚钱”。"),
]
...
qs = [
    ...
    ("④ 经营与资金", "为什么“单品盈利”没带来“整体赚钱”？现金流是不是生死线？怎么起步才能活得久？"),
]
